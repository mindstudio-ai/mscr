import { UpdateDashboardShareInputs } from './type';
...
export const handler = async ({
  ...
  setOutput,
  log,
}: IHandlerContext<UpdateDashboardShareInputs>) => {
  if (!inputs.sightId) {
  ...
  try {
    ...
    throw new Error(`Failed to update dashboard share: ${errorMessage}`);
  }
};
