export const handler = async ({
  ...
  if (!consumerKey || !consumerSecret) {
    throw new Error('Missing API credentials. Please configure your WooCommerce Consumer Key and Consumer Secret in the connector settings.');
  }
  ...
  if (!shippingClassId) {
    throw new Error('Missing shipping class ID. Please provide a valid shipping class ID.');
  }
  ...
  try {
    ...
    throw new Error('An unknown error occurred while deleting the shipping class');
  }
};